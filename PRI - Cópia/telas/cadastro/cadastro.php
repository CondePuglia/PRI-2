...
<body class="cp1">
    ...
    <div class="container cp2 p-5">
        <section class="section-1 cp2 p-5 mb-3">
            <h1 class=" arvo cp3c">Formulário de Cadastro</h1>
            
        </section>
        <hr class="border-cp3">
    <section class="section-2 cp2 p-5 mb-3">
    <form class="form-control p-5" id="form" method="POST">
  <div class="mb-3">
    <label for="name" class="form-label mm2 raleway fw-bold cp1">Nome de Usuário:</label>
    <input type="name" class="form-control required raleway" oninput="nameValidate()" id="name" name="name"  placeholder="Digite seu nome">
  ...
  <div class="mb-3">
    ...
    <input type="email" class="form-control required raleway" oninput="emailValidate()" id="email" name="email" placeholder="Digite seu email">
    <span class="hidden mp2 ">Digite um email válido</span>
  </div>
  <div class="mb-3">
    <label for="password" class="form-label mm2 raleway  fw-bold cp1">Senha:</label>
    <input type="password" oninput="mainPasswordValidate()" class="form-control required raleway" id="password" name="password"  placeholder="Digite sua senha">
  ...
  <div class="row my-5">
    <div class="col-2">
  <button type="submit" class="btn cp3 mm2 arvo">Cadastrar</button>
  </div>
  <div class="col-7">
  <button type="reset" class="btn cp2-5 mm2 arvo">Limpar</button>
  </div>
  <div class="col-3">
  <p class="raleway"><small>Já Possui Conta?<a href="../login/login.php" class="fw-bold">Clique Aqui</a></small></p>
  </div>
  </div>
</form>
