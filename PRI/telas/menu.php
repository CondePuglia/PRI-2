    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="../Data/Data.php" class="nav-link px-2  apagar fs-5  mx-2 arvo fw-medium menuD">Data</a></li>
                <li><a href="#" class="nav-link px-2 apagar fs-5  mx-2 arvo fw-medium menuI">Immersus</a></li>
                <?php
            ...
            ?>
                <span class="navbar-text">
                    ...
                    <span class="fs-4 mx-2 text-warning">Bem Vindo, <?= nome_usuario(); ?></span>
                </span>
