<div class="">
  <?php
  require "../../conexao.php";
  $sql = "SELECT l.CodSen, l.nameLocal FROM local l INNER JOIN usuario u ON l.codusu=u.codusu  WHERE l.codusu = ?";
  ...
  <div>
    ...
    <div class="list-group rolagem" style="max-height: 300px; overflow-y: auto;">
      ...
      ?>
        <a href="../graficos/grafico.php?nameLocal=<?= $row["namelocal"] ?> &codsen=<?= $row["codsen"] ?>" class="list-group-item list-group-item-action cp3"> <span class="arvo"><?= $row["namelocal"] ?></span></a>
      <?php
