...
<div class="flex-column flex-grow-1">
            ...
            <form action="alterar-nome.php" method="post">
                ...
                <div class="row">
                    <div class="form-floating col-8 offset-1">
                        <input type="password" class="form-control raleway fw-bolder" id="floatingPassword" placeholder="Password" disabled="" value="*****************************************************">
    ...
    <div class="row ">
        <div class="col-4 offset-4">
            <?php
            if (isset($_SESSION["result_usuario"]) || isset($_SESSION["result_nome"]) || isset($_SESSION["result_local"])) {
                if (
                    !isset($_SESSION["result_usuario"]) || !isset($_SESSION["result_nome"]) || !isset($_SESSION["result_local"]) ||
                    !$_SESSION["result_usuario"] || !$_SESSION["result_nome"]  || !$_SESSION["result_local"]
                ) {
            ...
            ?>
                    ...
                    <div id="modal-overlay" style="display: <?php echo (isset($_SESSION["result_usuario"]) || isset($_SESSION["result_nome"]) || isset($_SESSION["result_local"])) ? 'flex' : 'none'; ?>;">
            ...
            <?php
                ...
                unset($_SESSION["result_usuario"]);
                unset($_SESSION["result_nome"]);
                unset($_SESSION["result_local"]);
            }
            ?>
        </div>
    </div>
