...
<div class="cd1">
  <footer class="py-3">
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
      ...
      <li class="nav-item"><a href="../data/data.php" class="nav-link px-2 text-white">Data</a></li>
      <li class="nav-item"><a href="../imer/immersus.php" class="nav-link px-2 text-white">Immersus</a></li>
