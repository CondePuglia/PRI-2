...
<body class="cp1">
    <div class="container">
        ...
        <div class="form">
            <form action="login.php" method="POST" id="form" class="form-control form-control-retangulo">
                <fieldset>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control fw-normal required" id="email" name="email" required>
                    <span class="error-msg"></span>
                </div>
                <div class="mb-3"> 
                    <label for="senha" class="form-label raleway  fw-bold ">Senha: </label>
                    <input type="password" class="form-control fw-normal mb-3 required" name="senha" id="senha" required>
                    <span class="error-msg"></span>
                </div>
                <div class="avisos">
                </div> 
