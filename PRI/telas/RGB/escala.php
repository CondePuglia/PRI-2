...
if (empty($temp) || empty($lumi) || empty($umi) || empty($dtaini) || empty($dtafim)) {
    $_SESSION["result_escala"] = false;
    $_SESSION["erro"] = "Por favor, siga as instruções, para gerar a escala.";
